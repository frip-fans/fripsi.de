INSERT OR IGNORE INTO events (
  ...
  ('evt_demo_tokyo', '2026-08-31-fripside-fan-calendar-demo', 'fripSide Event Calendar Demo', '2026-08-31', NULL, '18:00', NULL, 'Asia/Tokyo', 'EVENT', 'Demo', 'Tokyo', 'Tokyo', '本记录仅用于本地开发，请在导入正式数据前移除。', 'scheduled', 1, 1, '2026-07-18T12:00:00Z', '2026-07-18T12:00:00Z', '2026-07-18T12:00:00Z'),
  ('evt_demo_release', '2026-07-20-fripside-release-demo', 'Release Archive Demo', '2026-07-20', NULL, NULL, NULL, 'Asia/Tokyo', 'RELEASE', 'Demo', NULL, NULL, '本记录仅用于本地开发。', 'completed', 1, 1, '2026-07-18T12:00:00Z', '2026-07-18T12:00:00Z', '2026-07-18T12:00:00Z');
